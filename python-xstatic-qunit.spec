...
Version:        XXX
Release:        1%{?dist}
Summary:        QUnit JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-qunit/
...
%description
QUnit javascript library packaged for
...
%files
%doc README.txt
%{python_sitelib}/XStatic_QUnit-%{version}-py?.?.egg-info
%{python_sitelib}/XStatic_QUnit-%{version}-py?.?-nspkg.pth
%{python_sitelib}/xstatic/pkg/qunit
